...
Furthermore, it could also be possible to reverse this logic in regions that have instead been subject to relative sea-level rise, where the date for when a location was inundated can provide a *terminus ante quem* date -- the latest possible date for the use of a site. However, implenention of *shoredate* to regions which have experienced continous or disjoint phases of sea-level transgression remains to be developed.
