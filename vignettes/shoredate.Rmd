...
<div class="figure" style="text-align: center">
<img src="shore-plot_intcurve-1.png" alt="plot of chunk plot_intcurve"  />
<p class="caption">plot of chunk plot_intcurve</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="shore-tpq_date-1.png" alt="plot of chunk tpq_date"  />
<p class="caption">plot of chunk tpq_date</p>
</div>
...
```
## Warning in matrix(unlist(x, use.names = FALSE), nrow = length(x), byrow = TRUE, : data length [3] is not a sub-multiple or multiple of the number of
## rows [2]
```
...
<div class="figure" style="text-align: center">
<img src="shore-plot_example_isobases-1.png" alt="plot of chunk plot_example_isobases"  />
<p class="caption">plot of chunk plot_example_isobases</p>
</div><div class="figure" style="text-align: center">
<img src="shore-plot_example_isobases-2.png" alt="plot of chunk plot_example_isobases"  />
<p class="caption">plot of chunk plot_example_isobases</p>
</div>
