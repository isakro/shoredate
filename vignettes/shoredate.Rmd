...
knitr::include_graphics(
  file.path(system.file("precompiled_figures", package = "shoredate"), "spatiotemporal_coverage.png")
)
```
...
```{r plot_intcurve, fig.width = 5.5, fig.height = 4.2}
...
target_crs <- sf::st_transform(target_point, crs = 4326)

# Retrieve raster data 
elevation <- elevatr::get_elev_raster(target_crs, z = 14,  src = "aws")
