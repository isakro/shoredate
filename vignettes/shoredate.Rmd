...
Note that the package is being actively developed and could be unstable. When installed the package can be loaded:
...
```{r plot_intcurve, fig.width = 5.3, fig.height = 4}
...
# Using the same target point and elevation as above, but specifying two different directions for 
# the isobases when dating
